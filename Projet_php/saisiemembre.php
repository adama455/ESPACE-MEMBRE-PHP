...
<head>
    ...
    <title>SaisieMembre</title>
</head>
<body style="background-image:url(img/unnamed.gif);">


   <div class="container col-sm-6 mt-5 btn-primary ">
   <form method="post" action="controlmembre.php" class="form-control">
   <br><h2 class="text-center">MEMBRE</h2><br>
        <div class="mb-3 row">
        ...
        <input type="text" class="form-control" name="tel">
         ...
         <!-- Submit button -->
            <input type="submit" name="submit" id="button" class="btn btn-success btn-block" value="Enregistrer">
